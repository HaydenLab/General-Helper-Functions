...
endoffset = 3;
binwidth = 0.001; % s
env_strobe = 6002; % see the end for strobe meanings
align_by = 'start'; %'start'; %'start'%'choice' % change to env_strobe
isRipple = 1;

% CHANGE ME
save_path = sprintf('/Users/jiaxintu/Documents/Data/StagOpts_Caleb/lfads/tensor/first_aligned_%db%da',startoffset,endoffset);
% CHANGE ME
